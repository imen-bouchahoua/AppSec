...
public class SteganographyController {
    ...
    public Response hideMessage(
        ...
        validateInputsHide(image, message, key);

        BufferedImage img = ImageIO.read(image.getContent());

        byte[] markedImagePath = steganographyService.hideMessage(message, img, key);
        ...
        return Response.ok(markedImagePath)
    ...
    public Response extractMessage(
        ...
        return Response.ok("Message extrait : " + extractedMessage).build();
    }
