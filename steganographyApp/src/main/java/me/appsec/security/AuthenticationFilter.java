...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) {
        ...
        try{
            logger.info("filter is being validated!");
            // validate the token
            InitialContext context = new InitialContext(); // JNDI object
            JwtManager manager = (JwtManager) context.lookup("java:global/iam-1.0/JwtManager!me.appsec.JwtManager");//the last value in the jndi name must match the name of the EJB class managing your JWT
